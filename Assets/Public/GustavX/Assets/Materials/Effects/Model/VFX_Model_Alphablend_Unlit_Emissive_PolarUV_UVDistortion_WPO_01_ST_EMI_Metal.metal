...
vertex VertexOutput GustavX_Model_VFX_Model_Alphablend_Unlit_Emissive_PolarUV_UVDistortion_WPO_01_ST_EMI_vertexMain(constant _CB_MaterialConstants& CB_MaterialConstants [[buffer(MATERIAL_CONSTANTS_BINDING_POINT)]],
...
fragment PixelOutput GustavX_Model_VFX_Model_Alphablend_Unlit_Emissive_PolarUV_UVDistortion_WPO_01_ST_EMI_fragmentMain(constant _CB_MaterialConstants& CB_MaterialConstants [[buffer(MATERIAL_CONSTANTS_BINDING_POINT)]],
	constant _PerFrame& PerFrame [[buffer(PER_FRAME_BINDING_POINT)]],
	constant _PerCamera& PerCamera [[buffer(PER_CAMERA_BINDING_POINT)]],
