...
vertex VertexOutput GustavX_Effects_VFX_OverlayMaterial_AlphaBlend_Unlit_Emissive_SceneColor_Fresnel_DepthBlend_WPO_LateAlpha_Spectre_01_ST_FOR_vertexMain(constant _CB_MaterialConstants& CB_MaterialConstants [[buffer(MATERIAL_CONSTANTS_BINDING_POINT)]],
...
fragment PixelOutput GustavX_Effects_VFX_OverlayMaterial_AlphaBlend_Unlit_Emissive_SceneColor_Fresnel_DepthBlend_WPO_LateAlpha_Spectre_01_ST_FOR_fragmentMain(constant _CB_MaterialConstants& CB_MaterialConstants [[buffer(MATERIAL_CONSTANTS_BINDING_POINT)]],
	constant _CB_EngineParams& CB_EngineParams [[buffer(ENGINE_PARAMS_BINDING_POINT)]],
	constant _PerFrame& PerFrame [[buffer(PER_FRAME_BINDING_POINT)]],
	constant _PerCamera& PerCamera [[buffer(PER_CAMERA_BINDING_POINT)]],
	...
	FOG_PARAMS)
{
	...
	CalculateMatEmissiveColor(CB_MaterialConstants, CB_EngineParams, PerFrame, PerCamera, VirtualTexture_TilesetDataBuffer, Local0, In.TexCoords0, In.LocalPosition.xyz, localNormalNormalized, CB_MaterialConstants.DynamicParameter, tangentView, In.Depth, matEmissiveColor, _PointMirrorSampler, _LinearDepth, VirtualTexture_Pagetable, _DefaultBorderSampler, _DefaultWrapSampler, _Scene, Texture2DParameter_basecolor, Texture2DParameter_Triplanar_Texture_Map, VirtualTexture_Cache1, Texture2DParameter_NM, _DefaultClampSampler, Texture2DParameter_ColorRamp_Texture_DefaultClampSampler);
